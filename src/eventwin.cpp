...
void tEventWinDlg::AddProperties()
{
...
//   AssociatePanel(panel);
  ...
  //xsize
   sheet->AddProperty(new wxProperty("Event Size", tNamedValueListValue((long*)&EventWin->ClocksPerPixel, xSizes) , 
  				    "props", new tNamedValueListValidator(xSizes)))  ;

   //ysize
   sheet->AddProperty(new wxProperty("Font Size", tNamedValueListValue((long*)&EventWin->FontSize, ySizes) , 
  				    "props", new tNamedValueListValidator(ySizes)))  ;
   //usecolors
   sheet->AddProperty(new wxProperty("Use Colors", wxPropertyValue((bool*)&EventWin->UseColors), "bool"));
}
