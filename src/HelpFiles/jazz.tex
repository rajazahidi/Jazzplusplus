...
\author{Pete Stieber $<$pstieber@verizon.net$>$}%
\date{May 2008}%
\makeindex%
\begin{document}%
\maketitle%
...
Intel based 'PC' hardware platforms (x86_32bit and x86_64bit), and also Mac
...
\begin{indented}{2cm}
\urlref{http://www.wxwidgets.org/}{http://www.wxwidgets.org/}
\end{indented}
...
JAZZ++ Subversion repository at ;
 ...
 \begin{indented}{2cm}
\urlref{http://jazzplusplus.sourceforge.net/subversion}{
http://jazzplusplus.sourceforge.net/subversion}
\end{indented}
...
submitting emails to the lists. 
 ...
 \begin{indented}{2cm}
\urlref{http://jazzplusplus.sourceforge.net/mailinglist}{
http://jazzplusplus.sourceforge.net/mailinglist}
\end{indented}
...
\begin{indented}{2cm}
\urlref{https://lists.sourceforge.net/lists/listinfo/jazzplusplus-user}{
https://lists.sourceforge.net/lists/listinfo/jazzplusplus-user}
\end{indented}

The second is devoted to developers.  To subscribe visit

\begin{indented}{2cm}
\urlref{https://lists.sourceforge.net/lists/listinfo/jazzplusplus-devel}{
...
\begin{indented}{2cm}
\urlref{https://lists.sourceforge.net/lists/listinfo/jazzplusplus-updates}{
https://lists.sourceforge.net/lists/listinfo/jazzplusplus-updates}
\end{indented}
...
problem, and how to submit that bug report in a meaningful and consistant way ;
 ...
 \begin{indented}{2cm}
\urlref{http://jazzplusplus.sourceforge.net/bugreports}{
http://jazzplusplus.sourceforge.net/bugreports}
\end{indented} 
...
\item{Setting up a Linux softsynth}
...
\item[How powerful does my computer need to be to run JAZZ++ properly?]
...
exhaustive list -- however, here are some pointers to help people out ;
    ...
    http://wiki.mandriva.com/en/Docs/Howto/Mandriva_Kernels#kernel-rt
