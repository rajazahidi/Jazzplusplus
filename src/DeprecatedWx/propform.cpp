...
bool wxPropertyFormView::Check(void)
{
    ...
    ++iProperty)
  {
    ...
    wxPropertyValidator* pValidator = FindPropertyValidator(pProperty);
    if (pValidator && pValidator->IsKindOf(CLASSINFO(wxPropertyFormValidator)))
    {
      wxPropertyFormValidator* pFormValidator =
        (wxPropertyFormValidator*)pValidator;
      if (!pFormValidator->OnCheckValue(pProperty, this, m_propertyWindow))
      {
        return false;
      }
    }
...
bool wxPropertyFormView::TransferToPropertySheet(void)
{
    ...
    ++iProperty)
  {
    ...
    if (pValidator && pValidator->IsKindOf(CLASSINFO(wxPropertyFormValidator)))
    {
      wxPropertyFormValidator* pFormValidator =
        (wxPropertyFormValidator*)pValidator;
      pFormValidator->OnRetrieveValue(pProperty, this, m_propertyWindow);
    }
  }
...
bool wxPropertyFormView::TransferToDialog(void)
{
    ...
    ++iProperty)
  {
    ...
    if (pValidator && pValidator->IsKindOf(CLASSINFO(wxPropertyFormValidator)))
    {
      wxPropertyFormValidator* pFormValidator =
        (wxPropertyFormValidator*)pValidator;
      pFormValidator->OnDisplayValue(pProperty, this, m_propertyWindow);
    }
  }
...
bool wxPropertyFormView::AssociateNames(void)
{
    ...
    wxWindowList::compatibility_iterator node =
      m_propertyWindow->GetChildren().GetFirst();
    while (node)
    {
...
void wxPropertyFormView::OnCommand(wxWindow& win, wxCommandEvent& event)
{
  ...
  else
  {
    ...
    {
      wxProperty* pProperty = iProperty->second;
      if (pProperty->GetWindow() && (pProperty->GetWindow() == &win))
      {
        wxPropertyValidator* pValidator = FindPropertyValidator(pProperty);
        if (
          pValidator &&
          pValidator->IsKindOf(CLASSINFO(wxPropertyFormValidator)))
        {
          wxPropertyFormValidator* pFormValidator =
            (wxPropertyFormValidator*)pValidator;
          pFormValidator->OnCommand(pProperty, this, m_propertyWindow, event);
          return;
        }
      }
    }
...
void wxPropertyFormView::OnDoubleClick(wxControl *item)
{
  ...
  {
    wxProperty* pProperty = iProperty->second;
    if (pProperty->GetWindow() && ((wxControl*)pProperty->GetWindow() == item))
    {
      wxPropertyValidator* pValidator = FindPropertyValidator(pProperty);
      if (
        pValidator &&
        pValidator->IsKindOf(CLASSINFO(wxPropertyFormValidator)))
      {
        wxPropertyFormValidator* pFormValidator =
          (wxPropertyFormValidator*)pValidator;
        pFormValidator->OnDoubleClick(pProperty, this, m_propertyWindow);
        return;
      }
    }
  }
