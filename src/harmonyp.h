...
// PAT - I commented this next line out.
//#define bool int
#define true 1
#define false 0
...
class HBChord {
    friend ostream & operator << (ostream &os, HBChord const &a);
...
class HBContext
{
    ...
    friend ostream & operator << (ostream &os, HBContext const &a);
    friend istream & operator >> (istream &is, HBContext &a);
