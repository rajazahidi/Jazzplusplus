...
#define ID_TRIM                              wxID_HIGHEST + 3
#define ID_QUANTIZE                          wxID_HIGHEST + 4
#define ID_SHIFT_LEFT                        wxID_HIGHEST + 5
#define ID_SHIFT_RIGHT                       wxID_HIGHEST + 6
#define ID_SNAP_8                            wxID_HIGHEST + 7
#define ID_SNAP_8D                           wxID_HIGHEST + 8
#define ID_SNAP_16                           wxID_HIGHEST + 9
...
#define ID_RECORD                            wxID_HIGHEST + 16
#define ID_METRONOME                         wxID_HIGHEST + 17

#define ID_SELECT                            wxID_HIGHEST + 18

#define ID_CHANGE_LENGTH                     wxID_HIGHEST + 19

#define ID_EVENT_DIALOG                      wxID_HIGHEST + 20
