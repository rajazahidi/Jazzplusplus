\documentstyle[a4,makeidx,verbatim,texhelp,fancyhea]{report}%
\input{psbox.tex}
\parskip=10pt%
\parindent=0pt%
\title{the JAZZ++ midi sequencer\\
version 3.2}%
...
types, a {\em random rhythm generator} and a {\em harmony browser}. Windows versions of
JAZZ++ can be synchronized to other sound equipment (e.g. a tape recorder)
using Midi Time Code (MTC) or SongPointer synchronization techniques.
...
\htmlonly{\image{0cm;0cm}{jzwins.gif}}%
...
synthesizer can either be an integrated part of a sound-card, or an
external device attached to the PC with a cable. To record midi music you
will need a midi-capable piano-keyboard attached to the PC (as an alternative
you can enter notes using the mouse).
...
supports 32-bit platforms (e.g. win95).
...
For latest updates on software from {\em JazzWare}, please look at the
JAZZ++ homepage at

\begin{indented}{2cm}
{\tt http://www.jazzware.com}
\end{indented}
...
\htmlonly{\image{0cm;0cm}{trackwin.gif}}%
...
\htmlonly{\image{0cm;0cm}{twtoolb.gif}}%
...
\htmlonly{\image{0cm;0cm}{twselect.gif}}%
...
\htmlonly{\image{0cm;0cm}{recplay.gif}}%
...
\htmlonly{\image{0cm;0cm}{speed.gif}}%
...
\htmlonly{\image{0cm;0cm}{trackdef.gif}}%
...
\htmlonly{\image{0cm;0cm}{tracknam.gif}}%
...
\htmlonly{\image{0cm;0cm}{replic.gif}}%
...
\htmlonly{\image{0cm;0cm}{delete.gif}}%
...
\htmlonly{\image{0cm;0cm}{quantize.gif}}%
...
\htmlonly{\image{0cm;0cm}{setchan.gif}}%
...
\htmlonly{\image{0cm;0cm}{transpos.gif}}%
...
\htmlonly{\image{0cm;0cm}{veloc.gif}}%
...
\htmlonly{\image{0cm;0cm}{shift.gif}}%
...
\htmlonly{\image{0cm;0cm}{cleanup.gif}}%
...
\htmlonly{\image{0cm;0cm}{search.gif}}%
...
\htmlonly{\image{0cm;0cm}{mixer.gif}}%
...
\htmlonly{\image{0cm;0cm}{filter.gif}}%
...
\htmlonly{\image{0cm;0cm}{songset.gif}}%
...
\htmlonly{\image{0cm;0cm}{metroset.gif}}%
...
\htmlonly{\image{0cm;0cm}{syntype.gif}}%
...
\htmlonly{\image{0cm;0cm}{meter.gif}}%
...
\htmlonly{\image{0cm;0cm}{hbtoolb.gif}}%
...
\htmlonly{\image{0cm;0cm}{rrgtoolb.gif}}%
...
\htmlonly{\image{0cm;0cm}{pianowin.gif}}%
...
\htmlonly{\image{0cm;0cm}{pwtoolb.gif}}%
...
\htmlonly{\image{0cm;0cm}{eventdlg.gif}}%
...
\htmlonly{\image{0cm;0cm}{pwevents.gif}}%
...
\htmlonly{\image{0cm;0cm}{pitched.gif}}%
...
\htmlonly{\image{0cm;0cm}{audiotrk.gif}}%
...
\htmlonly{\image{0cm;0cm}{audioset.gif}}%
...
\htmlonly{\image{0cm;0cm}{sampset.gif}}%
...
\htmlonly{\image{0cm;0cm}{sampedit.gif}}%
